...
export function SecondAccordion() {
  ...
  return (
    ...
    >
      <Accordion.Item value="item-1" className='pb-6 border-b-gray-200 border-b-[1px]'>
      ...
      <Accordion.Item value="item-2" className='py-6 border-b-gray-200 border-b-[1px]'>
        <Accordion.Trigger className='w-full'>
          <Header
      ...
      <Accordion.Item value="item-3" className='py-6 border-b-gray-200 border-b-[1px]'>
        <Accordion.Trigger className='w-full'>
          <Header
      ...
      <Accordion.Item value="item-4" className='py-6 border-b-gray-200 border-b-[1px]'>
        <Accordion.Trigger className='w-full'>
          <Header
      ...
      <Accordion.Item value="item-5" className='py-6 border-b-gray-200 border-b-[1px]'>
        <Accordion.Trigger className='w-full'>
          <Header
            title='The process is mostly easy when you need it'
            isActive={open}
